...
author:
  ...
  - name: Horacio Lopez-Nicora
    orcid: 0000-0002-9672-9589
    email: lopeznicora.1@osu.edu
    affiliation: 
      - name: Plant Pathology, Ohio State University
        url: https://plantpath.osu.edu/our-people/horacio-lopez-nicora
date: 2026-08-17
...
In this session, you will learn how to find your way around **RStudio**,
...
We will begin with raw data, perform exploratory analyses,
and learn how to plot results graphically.
This example starts with a dataset from [gapminder.org](https://www.gapminder.org/)
containing population information for many countries through time.
...
once you've designed an experiment and collected data,
the real fun begins with analysis!
*In this lesson, we will teach you some of the fundamentals of the R language*
*and share best practices for organizing code in scientific projects, which will make your life easier.*

Though we could use a spreadsheet in Microsoft Excel or Google Sheets to analyze
our data, these tools have limitations in terms of flexibility and accessibility.
Moreover, they make it difficult to share the steps involved in exploring and modifying raw data,
which is essential for conducting "reproducible" research.

Therefore, this lesson will guide you on how to start exploring your data using
...
there are endlessly available free resource to learn how to do practically
...
- In your R script, comments are formatted differently so you can clearly
...
With `c()`, you can create _vectors_ that contain multiple items, like multiple numbers.
