...
It is common to want vectors with **series of numbers**,
and a handy shortcut to make series of whole numbers (integers) is by using the
`:` operator:
...
- Get the second through the fifth elements with `[2:4]`:
...
And you saw in the exercise above that R can't compute the mean of a vector
with bird names.
