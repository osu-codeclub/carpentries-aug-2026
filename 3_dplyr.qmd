...
i.e. data with rows and columns.
In this session,
...
We'll see some examples very soon.
...
_dplyr_ has a host of other functions.
Some of these are more advanced than the ones we'll cover today,
...
:::exercise
#### {{< fa user-edit >}} **Challenge 2: Find the extremes**
